      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', lineHeight: '1.5', minHeight: '42px' }}>
              Create a public account to submit, track, and monitor civic grievances in your locality.
            </p>
          </div>
        ...
        >
          <div>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', lineHeight: '1.5', minHeight: '42px' }}>
              Register as an authorized field officer for municipal operations and problem resolution.
            </p>
          </div>
        ...
        >
          <div>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', lineHeight: '1.5', minHeight: '42px' }}>
              Register high-level system administrator access with authorized provisioning setup code.
            </p>
          </div>
